...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn btn-sm btn-success ms-2 px-3" href="{{ route('login') }}">Login</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-duration="1000" data-aos-delay="200">
                    <img src="{{ asset('images/dashboard-illustration.svg') }}" alt="Dashboard Illustration"
                        class="img-fluid">
                </div>
            </div>
        </div>
    ...
    <section class="py-5 bg-light" id="tentang">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1000">
                    <img src="{{ asset('images/about-illustration.svg') }}" alt="About Illustration" class="img-fluid">
                </div>
    ...
    <section class="py-5 bg-light">
        <div class="container py-5">
            <h2 class="section-title text-center mb-5">Desa/Kelurahan Cantik (Cinta Statistik)</h2>
        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <p class="mb-4">Jika Anda memiliki pertanyaan tentang Cerdas Survey Management atau ingin
                        mengintegrasikan platform ini dengan sistem Anda, jangan ragu untuk menghubungi kami.</p>
                    ...
                    <div class="mb-4">
                        <div class="d-flex mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">Jl. Statistik No. 123, Kota Pontianak, Kalimantan Barat</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">+62 561 123456</p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex">
                            ...
                            <div>
                                ...
                                <p class="text-muted mb-0">info@cerdas-sm.gov.id</p>
                            </div>
                        </div>
                    </div>
