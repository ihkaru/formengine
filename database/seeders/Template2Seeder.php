...
class Template2Seeder extends Seeder
{
    ...
    {
        $kegiatan = Kegiatan::find('REM-2024-1-PILOT-LAPANGAN');
...
JSON;
        ...
        // $this->seedMasterData();
        $kegiatan = Kegiatan::find('PLEM-2025-1-PILOT-LAPANGAN');

        $templateJson = "{\"id\":\"kuesioner-warga-desa-v4-final\",\"version\":\"1.3.0\",\"subkegiatanId\":\"pendataan-warga-final\",\"title\":\"Pilot Pendataan Lengkap Kelurahan Pulau Pedalaman\",\"sections\":[{\"id\":\"section_informasi_penting\",\"title\":\"Informasi Penting Petugas\",\"questions\":[{\"id\":\"info_awal\",\"type\":\"info\",\"text\":\"Pastikan Anda sudah menyapa responden dengan baik dan menjelaskan tujuan dari pendataan ini. Semua data dijamin kerahasiaannya.\",\"style\":{\"color\":\"#1976D2\",\"fontStyle\":\"italic\"}}]},{\"id\":\"section_identifikasi_keluarga\",\"title\":\"Bagian A: Identifikasi Keluarga & Ekonomi\",\"questions\":[{\"id\":\"nama_kepala_keluarga\",\"type\":\"text\",\"label\":\"Nama Kepala Keluarga\",\"required\":true,\"validation\":{\"rules\":[\"required\",\"maxLength:100\"]}},{\"id\":\"jenis_kelamin_kk\",\"type\":\"radio\",\"label\":\"Jenis Kelamin Kepala Keluarga\",\"required\":true,\"masterId\":\"master-gender\",\"validation\":{\"rules\":[\"required\"]}},{\"id\":\"nik_kepala_keluarga\",\"type\":\"number\",\"label\":\"NIK Kepala Keluarga\",\"required\":false,\"validation\":{\"rules\":[{\"pattern\":\"^[0-9]{16}$\",\"message\":\"NIK harus 16 digit angka.\"}]},\"description\":{\"text\":\"Isi dengan 16 digit NIK jika ada dan responden bersedia.\",\"style\":{\"color\":\"grey\"}}},{\"id\":\"nomor_hp_krt\",\"type\":\"text\",\"label\":\"Nomor HP yang bisa dihubungi\",\"required\":false,\"validation\":{\"rules\":[{\"pattern\":\"^(\\\\{2}62|0)8[0-9]{8,12}$\",\"message\":\"Format nomor HP tidak valid.\"}]}},{\"id\":\"jumlah_anggota_keluarga\",\"type\":\"number\",\"label\":\"Total anggota keluarga yang tinggal bersama\",\"required\":true,\"validation\":{\"rules\":[\"required\",{\"pattern\":\"^[1-9][0-9]*$\",\"message\":\"Jumlah harus minimal 1.\"}]}},{\"id\":\"nama_kontributor_utama\",\"type\":\"text\",\"label\":\"Nama Kontributor Utama Keluarga\",\"required\":true,\"validation\":{\"rules\":[\"required\"]},\"description\":{\"text\":\"Siapa anggota keluarga yang paling besar berkontribusi untuk pemenuhan kebutuhan sehari-hari?\",\"style\":{\"fontStyle\":\"italic\"}}},{\"id\":\"pekerjaan_kontributor_utama\",\"type\":\"select\",\"label\":\"Pekerjaan Utama dari Kontributor\",\"required\":true,\"masterId\":\"master-pekerjaan\",\"validation\":{\"rules\":[\"required\"]}},{\"id\":\"pengeluaran_keluarga_sebulan\",\"type\":\"number\",\"label\":\"Perkiraan Total Pengeluaran Keluarga Sebulan (Rp)\",\"required\":true,\"validation\":{\"rules\":[\"required\",{\"pattern\":\"^[0-9]+$\",\"message\":\"Hanya angka yang diperbolehkan.\"}]},\"description\":{\"text\":\"Perkiraan pengeluaran untuk semua kebutuhan dalam sebulan terakhir.\",\"style\":{}}}]},{\"id\":\"section_fokus_data_anggota\",\"title\":\"Bagian B: Fokus Disabilitas & Anak Putus Sekolah\",\"questions\":[{\"id\":\"info_disabilitas\",\"type\":\"info\",\"text\":\"Bagian ini untuk mendata anggota keluarga yang memiliki kesulitan fungsional.\",\"style\":{\"fontWeight\":\"bold\"}},{\"id\":\"anggota_disabilitas_list\",\"type\":\"repeater\",\"label\":\"Anggota Keluarga dengan Disabilitas\",\"addButtonLabel\":\"Tambah Anggota dengan Disabilitas\",\"itemTitlePrefix\":\"Anggota Disabilitas ke-\",\"minItems\":0,\"questions\":[{\"id\":\"nama_anggota_disabilitas\",\"type\":\"text\",\"label\":\"Nama Anggota\",\"required\":true},{\"id\":\"jenis_kesulitan\",\"type\":\"checkbox\",\"label\":\"Jenis Kesulitan yang Dialami\",\"required\":true,\"masterId\":\"master-jenis-disabilitas\"},{\"id\":\"jenis_kesulitan_lainnya\",\"type\":\"text\",\"label\":\"Sebutkan jenis kesulitan lainnya\",\"required\":true}]},{\"id\":\"anak_putus_sekolah_list\",\"type\":\"repeater\",\"label\":\"Anak Usia 7-18 Tahun yang Putus Sekolah\",\"addButtonLabel\":\"Tambah Anak Putus Sekolah\",\"itemTitlePrefix\":\"Anak Putus Sekolah ke-\",\"minItems\":0,\"questions\":[{\"id\":\"nama_anak_putus_sekolah\",\"type\":\"text\",\"label\":\"Nama Anak\",\"required\":true},{\"id\":\"pendidikan_terakhir\",\"type\":\"radio\",\"label\":\"Pendidikan Terakhir yang Ditamatkan\",\"required\":true,\"masterId\":\"master-pendidikan-terakhir-putus-sekolah\"}]}]},{\"id\":\"section_lokasi_foto\",\"title\":\"Bagian C: Lokasi dan Dokumentasi\",\"questions\":[{\"id\":\"lokasi_rumah\",\"type\":\"geolocation\",\"label\":\"Lokasi Rumah (Geotagging)\",\"required\":true},{\"id\":\"foto_bangunan\",\"type\":\"camera\",\"label\":\"Foto Bangunan Rumah\",\"required\":false,\"cameraFacing\":\"environment\"}]},{\"id\":\"section_metadata\",\"title\":\"Metadata Pendataan\",\"questions\":[{\"id\":\"waktu_mulai_pengisian\",\"type\":\"datetime-local\",\"label\":\"Waktu Mulai Pengisian\",\"required\":false,\"permissions\":{\"editable\":[]}},{\"id\":\"waktu_selesai_pengisian\",\"type\":\"datetime-local\",\"label\":\"Waktu Selesai Pengisian\",\"required\":false,\"permissions\":{\"editable\":[]}}]}],\"conditionalLogic\":[{\"if\":{\"questionId\":\"jenis_kesulitan\",\"values\":[\"lainnya\"]},\"then\":{\"show\":[\"jenis_kesulitan_lainnya\"],\"setRequired\":[\"jenis_kesulitan_lainnya\"]},\"else\":{\"hide\":[\"jenis_kesulitan_lainnya\"],\"unsetRequired\":[\"jenis_kesulitan_lainnya\"]}}]}";
        // Konfigurasi kolom HANYA untuk "Kepala Keluarga" dan "Jumlah Anggota Keluarga"
        $kolomWajibJson = "{\"kolom_wajib\":[{\"name\":\"nama_kepala_keluarga\",\"label\":\"Kepala Keluarga\",\"field\":\"nama_kepala_keluarga\",\"align\":\"left\"}],\"visible_columns\":[\"jumlah_anggota_keluarga\"]}";

        Template::create([
            "versi" => "1.3.0-final",
            "label_versi" => Constants::VERSI_TEMPLATE_LATEST, // Atau 'VERSI_TEMPLATE_LATEST'
            "template" => trim($templateJson),
            "kolom_wajib" => trim($kolomWajibJson),
            "kegiatan_id" => $kegiatan->id,
        ]);
    }
}
